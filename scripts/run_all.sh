#!/bin/bash
# Unified Launcher for EPH Simulation and Detail Viewer
# Run this script to start both backend and frontend components.
...
SIM_SCRIPT="scripts/run_simulation.jl"
...
# --- Cleanup Function ---
# Kills background processes when this script exits
cleanup() {
    echo ""
